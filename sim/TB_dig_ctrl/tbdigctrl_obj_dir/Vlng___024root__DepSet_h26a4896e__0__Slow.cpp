...
VL_ATTR_COLD void Vlng___024root___eval_static__TOP(Vlng___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.tbdigctrl__DOT__rst = 0U;
}
...
VL_ATTR_COLD void Vlng___024root___dump_triggers__act(Vlng___024root* vlSelf) {
    ...
    if ((2ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(posedge cmp)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vlng___024root___dump_triggers__nba(Vlng___024root* vlSelf) {
    ...
    if ((2ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(posedge cmp)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vlng___024root___ctor_var_reset(Vlng___024root* vlSelf) {
    ...
    vlSelf->cmp = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10061869555615269896ull);
    vlSelf->reset = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9928399931838511862ull);
    vlSelf->b = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 16900879642891266615ull);
    vlSelf->tbdigctrl__DOT__rst = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12867559175232616355ull);
    vlSelf->__Vtrigprevexpr___TOP__clk__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9526919608049418986ull);
    vlSelf->__Vtrigprevexpr___TOP__cmp__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 14969990026519495462ull);
}
