...
VL_ATTR_COLD void Vlng___024root___eval_initial(Vlng___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__Vtrigprevexpr___TOP__dac_clk__0 = vlSelfRef.dac_clk;
}
...
VL_ATTR_COLD void Vlng___024root___dump_triggers__act(Vlng___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge dac_clk)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vlng___024root___dump_triggers__nba(Vlng___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge dac_clk)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vlng___024root___ctor_var_reset(Vlng___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->dac_clk = VL_RAND_RESET_I(1);
    vlSelf->dac_rst = VL_RAND_RESET_I(1);
    vlSelf->b = VL_RAND_RESET_I(4);
    vlSelf->count = VL_RAND_RESET_I(3);
    vlSelf->__Vtrigprevexpr___TOP__dac_clk__0 = VL_RAND_RESET_I(1);
}
