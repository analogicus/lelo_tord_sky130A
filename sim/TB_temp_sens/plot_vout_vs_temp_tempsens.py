...
if __name__ == "__main__":
                ...
                for temp in temperatures:
                    ...
                    for file in out_files:
                        ...
                        if len(zero_crossings) > 8:
                            ...
                            # print(f'final Zero crossings found at indices: {final_zero_crossings.tolist()}')
                    ...
                    if (len(final_zero_crossings_vout_values.tolist()) > 4): # and not (case == "mc" and c == 5 and circuit_temperature == 125)):
                        print(f'zc > 8:Appending results for corner {corner}, voltage {voltage}, temp {final_temp}, frequency {final_clock_frequency}, duty cycle {final_duty_cycle}.')
                        ...
                        print(f'0 < zc < 8: Appending results for corner {corner}, voltage {voltage}, temp {final_temp}, frequency {final_clock_frequency}, duty cycle {final_duty_cycle}.')
    ...
    axs.legend(loc="upper left", fontsize=legend_fontsize, ncol=2)
