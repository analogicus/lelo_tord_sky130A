...
VL_INLINE_OPT void Vlng___024root___nba_sequent__TOP__0(Vlng___024root* vlSelf) {
    ...
    __Vtableidx1 = (((IData)(vlSelfRef.count) << 1U) 
                    | (IData)(vlSelfRef.rst));
    vlSelfRef.count = Vlng__ConstPool__TABLE_he45ea67d_0
        [__Vtableidx1];
    vlSelfRef.d = Vlng__ConstPool__TABLE_h668fdf6a_0
        [__Vtableidx1];
}
...
#endif
            VL_FATAL_MT("../../rtl/digtotime.v", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("../../rtl/digtotime.v", 1, "", "Active region did not converge.");
            }
