...
N 730 520 730 690 {lab=AorB}
N 740 390 740 430 {lab=D1andB}
N 720 390 720 430 {lab=D0andA}
N 950 720 950 760 {lab=VSS}
N 950 600 950 640 {lab=VDD}
N 780 670 910 670 {lab=CorD}
N 730 690 910 690 {lab=AorB}
...
N 1000 680 1080 680 {lab=R}
N 1200 770 1240 770 {lab=R_n}
N 1120 720 1120 760 {lab=VSS}
N 1120 600 1120 640 {lab=VDD}
N 560 790 1240 790 {lab=CLK}
N 1280 820 1280 860 {lab=VSS}
N 1280 700 1280 740 {lab=VDD}
N 1330 780 1370 780 {lab=OUT}
N 330 830 330 870 {lab=VSS}
N 330 710 330 750 {lab=VDD}
N 380 790 420 790 {lab=D0orD1}
N 500 930 500 970 {lab=VSS}
N 500 810 500 850 {lab=VDD}
N 420 880 460 880 {lab=D0orD1}
N 420 900 460 900 {lab=D2orD3}
N 420 790 420 880 {lab=D0orD1}
N 420 900 420 990 {lab=D2orD3}
N 330 1030 330 1070 {lab=VSS}
N 330 910 330 950 {lab=VDD}
N 380 990 420 990 {lab=D2orD3}
N 250 780 290 780 {lab=d0}
N 250 800 290 800 {lab=d1}
N 250 980 290 980 {lab=d2}
N 250 1000 290 1000 {lab=d3}
N 550 890 1380 890 {lab=EN}
N 1160 680 1200 680 {lab=R_n}
N 1450 920 1450 960 {lab=VSS}
N 1450 800 1450 840 {lab=VDD}
N 1500 880 1540 880 {lab=Q}
N 1370 780 1370 870 {lab=OUT}
N 1380 890 1410 890 {lab=EN}
N 1370 870 1410 870 {lab=OUT}
N 1200 680 1200 770 {lab=R_n}
N 260 610 560 610 {lab=CLK}
N 780 560 1060 560 {lab=CorD}
N 780 560 780 670 {lab=CorD}
N 560 610 560 790 {lab=CLK}
...
C {JNW_TR_SKY130A/JNWTR_ORX1_CV.sym} 910 690 0 0 {name=x17 }
...
C {devices/lab_wire.sym} 560 240 0 0 {name=p40 sig_type=std_logic lab=d0}
C {devices/lab_wire.sym} 880 240 0 0 {name=p43 sig_type=std_logic lab=d1}
C {devices/lab_wire.sym} 1200 240 0 0 {name=p44 sig_type=std_logic lab=d2}
C {devices/lab_wire.sym} 1520 240 0 0 {name=p45 sig_type=std_logic lab=d3}
C {devices/lab_wire.sym} 950 620 0 1 {name=p35 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 880 690 2 1 {name=p52 sig_type=std_logic lab=AorB}
C {devices/lab_wire.sym} 880 670 0 0 {name=p53 sig_type=std_logic lab=CorD}
C {JNW_TR_SKY130A/JNWTR_IVX1_CV.sym} 1080 680 0 0 {name=x15 }
C {devices/lab_wire.sym} 1120 740 2 0 {name=p46 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 1120 620 0 1 {name=p47 sig_type=std_logic lab=VDD}
C {JNW_TR_SKY130A/JNWTR_ANX1_CV.sym} 1240 790 0 0 {name=x16 }
C {devices/lab_wire.sym} 1280 840 2 0 {name=p48 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 1280 720 0 1 {name=p49 sig_type=std_logic lab=VDD}
C {devices/opin.sym} 1540 880 0 0 {name=p50 lab=Q}
C {devices/lab_wire.sym} 1050 680 0 0 {name=p51 sig_type=std_logic lab=R}
C {devices/lab_wire.sym} 1200 740 0 1 {name=p54 sig_type=std_logic lab=R_n}
...
C {JNW_TR_SKY130A/JNWTR_ORX1_CV.sym} 460 900 0 0 {name=x18 }
C {devices/lab_wire.sym} 330 730 0 0 {name=p60 sig_type=std_logic lab=VDD}
C {JNW_TR_SKY130A/JNWTR_ORX1_CV.sym} 290 1000 0 0 {name=x19 }
C {JNW_TR_SKY130A/JNWTR_ORX1_CV.sym} 290 800 0 0 {name=x20 }
C {devices/lab_wire.sym} 330 1050 2 1 {name=p61 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 330 930 0 0 {name=p62 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 500 950 2 1 {name=p63 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 500 830 0 0 {name=p64 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 270 980 0 0 {name=p65 sig_type=std_logic lab=d2}
C {devices/lab_wire.sym} 270 1000 2 1 {name=p66 sig_type=std_logic lab=d3}
C {devices/lab_wire.sym} 270 800 2 1 {name=p67 sig_type=std_logic lab=d1}
C {devices/lab_wire.sym} 270 780 0 0 {name=p68 sig_type=std_logic lab=d0}
C {devices/lab_wire.sym} 330 850 2 1 {name=p69 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 580 890 0 1 {name=p59 sig_type=std_logic lab=EN}
C {JNW_TR_SKY130A/JNWTR_ANX1_CV.sym} 1410 890 0 0 {name=x21 }
C {devices/lab_wire.sym} 1450 940 2 0 {name=p70 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 1450 820 0 1 {name=p71 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 950 740 2 0 {name=p72 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 410 790 0 1 {name=p34 sig_type=std_logic lab=D0orD1}
C {devices/lab_wire.sym} 410 990 2 0 {name=p73 sig_type=std_logic lab=D2orD3}
C {devices/lab_wire.sym} 1350 780 0 1 {name=p74 sig_type=std_logic lab=OUT}
