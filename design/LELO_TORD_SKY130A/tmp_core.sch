...
N 370 540 410 540 {lab=SWRST}
N 370 560 410 560 {lab=SWCAP2}
N 1310 540 1350 540 {lab=SWRST}
N 1310 560 1350 560 {lab=SWCAP1}
N 700 390 740 390 {lab=SWCAP1}
N 980 390 1020 390 {lab=SWCAP2}
N 780 300 1080 300 {lab=VOUT}
N 780 230 820 230 {lab=SWRST}
N 860 260 860 300 {lab=VOUT}
N 860 160 860 200 {lab=IPTAT}
N 1120 550 1220 550 {lab=DRAINCAP2}
N 780 300 780 340 {lab=VOUT}
N 780 440 780 480 {lab=VCAP1}
N 940 440 940 480 {lab=VCAP2}
N 940 300 940 340 {lab=VOUT}
...
N 620 300 660 300 {lab=SWCAP2}
N 620 340 660 340 {lab=SWRST}
N 620 320 660 320 {lab=VSS}
N 620 280 660 280 {lab=SWCAP1}
N 620 260 660 260 {lab=IPTAT}
N 620 240 660 240 {lab=VDD}
N 830 420 890 420 {lab=VSS}
C {devices/opin.sym} 1080 300 0 0 {name=p19 lab=VOUT}
C {devices/ipin.sym} 620 240 0 0 {name=p59 lab=VDD}
C {devices/ipin.sym} 620 300 0 0 {name=p79 lab=SWCAP2}
C {devices/ipin.sym} 620 280 0 0 {name=p80 lab=SWCAP1}
C {devices/ipin.sym} 620 320 0 0 {name=p1 lab=VSS}
...
C {devices/lab_wire.sym} 780 230 0 0 {name=p5 sig_type=std_logic lab=SWRST}
C {JNW_TR_SKY130A/JNWTR_ORX1_CV.sym} 410 560 0 0 {name=x6 }
C {devices/lab_wire.sym} 370 540 0 0 {name=p7 sig_type=std_logic lab=SWRST}
C {devices/lab_wire.sym} 370 560 0 0 {name=p8 sig_type=std_logic lab=SWCAP2}
...
C {devices/lab_wire.sym} 1350 540 0 1 {name=p14 sig_type=std_logic lab=SWRST}
C {devices/lab_wire.sym} 730 390 0 0 {name=p24 sig_type=std_logic lab=SWCAP1}
C {JNW_ATR_SKY130A/JNWATR_PCH_2C1F2.sym} 820 230 0 0 {name=x5 }
C {devices/lab_wire.sym} 860 230 0 1 {name=p20 sig_type=std_logic lab=vdd}
C {devices/lab_wire.sym} 970 480 0 1 {name=p18 sig_type=std_logic lab=VCAP2}
C {devices/lab_wire.sym} 670 480 0 1 {name=p21 sig_type=std_logic lab=VCAP1}
...
C {devices/lab_wire.sym} 1130 550 0 1 {name=p6 sig_type=std_logic lab=DRAINCAP2}
C {devices/lab_wire.sym} 590 550 0 0 {name=p22 sig_type=std_logic lab=DRAINCAP1}
C {devices/lab_wire.sym} 990 390 0 1 {name=p17 sig_type=std_logic lab=SWCAP2}
C {devices/lab_wire.sym} 1350 560 0 1 {name=p15 sig_type=std_logic lab=SWCAP1}
C {devices/lab_wire.sym} 840 420 0 1 {name=p25 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 990 420 0 1 {name=p26 sig_type=std_logic lab=VDD}
C {devices/ipin.sym} 620 340 0 0 {name=p3 lab=SWRST}
