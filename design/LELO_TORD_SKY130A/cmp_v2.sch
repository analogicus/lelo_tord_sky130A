...
C {devices/lab_wire.sym} 640 -410 0 0 {name=p6 sig_type=std_logic lab=OTA_VDD}
C {devices/lab_wire.sym} 510 -490 0 0 {name=p7 sig_type=std_logic lab=IB_gate}
