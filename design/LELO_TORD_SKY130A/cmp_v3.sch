...
N 340 -170 520 -170 {lab=#net1}
N 300 -100 560 -100 {lab=VSS}
N 560 -140 560 -100 {lab=VSS}
N 460 -320 460 -280 {lab=#net2}
N 460 -280 660 -280 {lab=#net2}
N 660 -320 660 -280 {lab=#net2}
N 560 -280 560 -200 {lab=#net2}
N 460 -350 500 -350 {lab=#net2}
N 500 -350 500 -280 {lab=#net2}
N 620 -350 660 -350 {lab=#net2}
N 620 -350 620 -280 {lab=#net2}
N 560 -170 600 -170 {lab=VSS}
N 600 -170 600 -100 {lab=VSS}
N 560 -100 600 -100 {lab=VSS}
N 460 -460 460 -380 {lab=#net3}
N 660 -460 660 -380 {lab=#net4}
N 700 -350 740 -350 {lab=VIP}
N 380 -350 420 -350 {lab=VIN}
N 500 -490 620 -490 {lab=#net3}
...
N 460 -420 540 -420 {lab=#net3}
N 540 -490 540 -420 {lab=#net3}
N 660 -420 740 -420 {lab=#net4}
N 740 -490 780 -490 {lab=#net4}
N 740 -490 740 -420 {lab=#net4}
N 300 -240 380 -240 {lab=#net1}
N 380 -240 380 -170 {lab=#net1}
N 300 -240 300 -200 {lab=#net1}
N 380 -240 740 -240 {lab=#net1}
N 740 -240 740 -170 {lab=#net1}
N 740 -170 780 -170 {lab=#net1}
...
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} 700 -350 0 1 {name=x2}
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} 520 -170 0 0 {name=x3[1:0]}
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} 420 -350 0 0 {name=x1}
