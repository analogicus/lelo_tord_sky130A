...
N 360 360 400 360 {lab=VSS}
N 360 480 400 480 {lab=VSS}
N 420 400 420 440 {lab=VR3}
N 420 280 420 320 {lab=V2}
N 420 520 420 560 {lab=NBIAS}
N 460 590 620 590 {lab=NBIAS}
N 540 590 540 630 {lab=NBIAS}
N 540 690 540 730 {lab=VSS}
N 420 620 420 730 {lab=VSS}
N 660 620 660 730 {lab=VSS}
N 360 730 660 730 {lab=VSS}
N 360 240 360 730 {lab=VSS}
...
C {JNW_ATR_SKY130A/JNWATR_NCH_2C5F0.sym} 500 660 0 0 {name=x7 }
C {JNW_ATR_SKY130A/JNWATR_PCH_2C5F0.sym} 530 130 0 0 {name=x8 }
C {JNW_ATR_SKY130A/JNWATR_PCH_2C5F0.sym} 790 130 0 1 {name=x9 }
C {devices/lab_wire.sym} 360 730 0 0 {name=p1 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 420 80 0 0 {name=p2 sig_type=std_logic lab=VDD}
C {devices/ipin.sym} 150 120 0 0 {name=p3 lab=VDD}
C {devices/ipin.sym} 150 140 0 0 {name=p4 lab=PWRUP}
C {devices/ipin.sym} 150 160 0 0 {name=p6 lab=VSS}
C {JNW_TR_SKY130A/JNWTR_IVX1_CV.sym} 120 320 0 0 {name=x10 }
C {devices/lab_wire.sym} 110 320 0 0 {name=p7 sig_type=std_logic lab=PWRUP}
C {devices/lab_wire.sym} 210 320 0 1 {name=p8 sig_type=std_logic lab=PWRUP_N}
...
C {devices/lab_wire.sym} 800 130 0 1 {name=p12 sig_type=std_logic lab=PWRUP}
