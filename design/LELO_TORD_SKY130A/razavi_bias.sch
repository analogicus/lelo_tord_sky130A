...
S {}
E {}
N 620 -630 700 -630 {lab=PBIAS}
N 740 -600 740 -490 {lab=NBIAS}
N 580 -440 580 -400 {lab=VR}
N 740 -690 740 -660 {lab=VDD}
N 580 -690 580 -660 {lab=VDD}
N 640 -630 640 -570 {lab=PBIAS}
N 580 -570 640 -570 {lab=PBIAS}
N 680 -530 740 -530 {lab=NBIAS}
...
N 410 -600 410 -560 {lab=NBIAS}
N 410 -500 410 -440 {lab=VSS}
N 410 -530 460 -530 {lab=VSS}
N 460 -530 460 -480 {lab=VSS}
N 410 -480 460 -480 {lab=VSS}
N 580 -600 580 -500 {lab=PBIAS}
N 680 -530 680 -470 {lab=NBIAS}
N 640 -570 660 -570 {lab=PBIAS}
N 740 -550 760 -550 {lab=NBIAS}
...
C {devices/lab_wire.sym} 410 -600 0 0 {name=p8 sig_type=std_logic lab=NBIAS}
C {devices/ipin.sym} 330 -530 0 0 {name=p21 lab=SPARK}
C {devices/opin.sym} 660 -570 0 0 {name=p15 lab=PBIAS}
C {devices/opin.sym} 760 -550 0 0 {name=p16 lab=NBIAS}
